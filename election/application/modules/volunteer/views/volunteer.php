                        ...
                        <a data-toggle="modal" href="#myModal">
                            <div class="btn-group">
                                <button id="" class="btn green">
                                    <i class="fa fa-plus-circle"></i>  <?php echo lang('add_volunteer'); ?>
                                </button>
                            </div>
                        </a>
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        <thead>
                            <tr>
                                ...
                                <th class="center"><?php echo lang('options'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                        ...
                        <?php foreach ($volunteers as $volunteer) { ?>
                            <tr class="">
                                ...
                                <td class="center"><?php if(!empty($volunteer->area)){echo $this->area_model->getAreaById($volunteer->area)->name;} ?></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="fa fa-plus-circle"></i> <?php echo lang('add_new_volunteer'); ?></h4>
            </div>
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title"><i class="fa fa-edit"></i> <?php echo lang('edit_volunteer'); ?></h4>
            </div>
            <div class="modal-body">
...
<div class="modal fade" id="myModal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title"><i class="fa fa-location-arrow"></i> <?php echo lang('send_sms_to_volunteer'); ?></h4>
            </div>
            <div class="modal-body">
