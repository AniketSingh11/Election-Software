        ...
        <div class="col-md-12">
            <section class="panel">
                <header class="panel-heading">
                    <i class="fa fa-location-arrow"></i> <?php echo lang('send_sms'); ?>
                </header>
                        ...
                        <section class="panel">
                            <div class="panel-body">         
                                <form role="form" action="sms/send" method="post">
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <div class="radio">
                                            <label>
                                                ...
                                                <?php echo lang('area_wise_volunteer'); ?> 
                                            </label>
                                        </div>
                                    ...
                                    <button type="submit" name="submit" class="btn btn-info"><i class="fa fa-location-arrow"></i> <?php echo lang('send_sms'); ?></button>
                                </form>
                            </div>
                        </section>
                    </div>
