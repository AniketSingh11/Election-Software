                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form role="form" action="sms/addNewSettings" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">ClickAtell <?php echo lang('username'); ?></label>
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">ClickAtell <?php echo lang('api'); ?> <?php echo lang('password'); ?></label>
