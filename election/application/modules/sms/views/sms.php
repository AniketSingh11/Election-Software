    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                <i class="fa fa-home"></i> <?php echo lang('sent_messages');?>
            </header>
            <div class="panel-body">
                <div class="adv-table editable-table ">
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        ...
                        <tbody>
                            <?php $i = 0; foreach ($sents as $sent) { $i = $i + 1; ?>
                                <tr class="">
                                    <td><?php echo $i; ?></td>
                                    <td style='width: 25%;'><?php echo date('h:i:s a m/d/y', $sent->date); ?></td>
                                    <td><?php if(!empty($sent->message)){echo $sent->message;} ?></td>
                                    <td><?php if(!empty($sent->recipient)){echo $sent->recipient;} ?></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
