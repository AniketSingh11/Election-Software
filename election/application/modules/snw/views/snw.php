    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                <i class="fa fa-archive"></i> <?php echo lang('campaign_analysis'); ?>
            </header>
                    ...
                    <div class="clearfix btn_margin">                        
                        <div class="btn-group">
                            <button id="" class="btn green addbutton" data-toggle="modal" href="#myModal" data-id="1">
                                <i class="fa fa-plus-circle"></i> <?php echo lang('add_strength'); ?>
                            </button>
                        </div> 
                    ...
                    <div class="clearfix btn_margin">
                        <div class="btn-group">
                            <button id="" class="btn green addbutton" data-toggle="modal" href="#myModal" data-id="2">
                                <i class="fa fa-plus-circle"></i>  <?php echo lang('add_weakness'); ?> 
                            </button>
                        </div>                        
                        <button class="export" onclick="javascript:window.print();"><?php echo lang('print'); ?></button>  
                    </div>
                ...
                <div class="adv-table editable-table col-md-6 padding" style="background: #f1f1f1;">
                    <div class="clearfix btn_margin">
                        <div class="btn-group">
                            <button id="" class="btn green addbutton" data-toggle="modal" href="#myModal" data-id="3">
                                <i class="fa fa-plus-circle"></i> <?php echo lang('add_opportunity'); ?> 
                            </button>
                        </div>                        
                        <button class="export" onclick="javascript:window.print();"><?php echo lang('print'); ?></button>  
                    </div>
                    ...
                    <table class="table table-striped table-hover table-bordered" id="">
                        <thead>
                            <tr>
                                <th>#</th>                        
                                <th><?php echo lang('opportunity'); ?></th>
                                <th><?php echo lang('note'); ?></th>
                                <th><?php echo lang('options'); ?></th>
                            </tr>
                        </thead>
                    ...
                    <div class="clearfix btn_margin">
                        <div class="btn-group">
                            <button id="" class="btn green addbutton" data-toggle="modal" href="#myModal" data-id="4">
                                <i class="fa fa-plus-circle"></i>  <?php echo lang('add_threat'); ?> 
                            </button>
                        </div>                        
                        <button class="export" onclick="javascript:window.print();"><?php echo lang('print'); ?></button>  
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="fa fa-plus-circle"></i> <?php echo lang('add_analysis'); ?></h4>
            </div>
            <div class="modal-body">
                <form role="form" id="snwAddForm" action="snw/addNew" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="type" value=''>
                    <div class="form-group">
                        <label for="exampleInputEmail1"><?php echo lang('topic'); ?></label>
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title"><i class="fa fa-edit"></i> <?php echo lang('edit_analysis'); ?></h4>
            </div>
            <div class="modal-body">
