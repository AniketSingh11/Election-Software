...
<html lang="en">
    <head>
        ...
        <title>Election Campaign System</title>
    ...
    <body class="login-body" style='background-image: url("bg.jpg");'>
        <div class="container">
            <form class="form-signin" method="post" action="auth/login">
                <h2 class="login form-signin-heading">Election Campaign System</br></br>
